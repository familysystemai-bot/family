...
# Gatekeeper: يعترض رسائل العملاء المحظورين قبل استدعاء الـ LLM لتوفير التوكنز،
# ويعيد ردًّا طريفًا ثابتًا يخبر العميل بأن الموظف سيرد لاحقًا يدويًا.
WA_BLOCKED_AI_AUTOREPLY_AR = (
    "عذراً، النظام قرر أخذ استراحة من رسائلك العبثية لتوفير الطاقة! "
    "سيتم الرد عليك يدوياً لاحقاً."
)
