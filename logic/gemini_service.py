...
_PRODUCT_ANALYSIS_PROMPT = (
    ...
    "1) اوصف بإيجاز (جملة أو جملتين بالعربية) ما هو المنتج الظاهر، "
    "وكأن العميل يطلبه في متجر ملابس وإكسسوارات. لا تخترع تفاصيل، فقط ما تراه. "
    "2) في سطر جديد منفصل اكتب بالضبط: SEARCH: ثم 4 إلى 10 كلمات مفتاحية بالعربية "
    "(نوع القطعة، لون، مناسبة، قصّة إن وُجدت) مفصولة بمسافات فقط — بدون فواصل أو شرح، "
    "لأنها تُستخدم للبحث في قاعدة بيانات المنتجات (مثال: SEARCH: فستان سواريه طويل ذهبي نسائي). "
    "إن كانت الصورة غير واضحة أو لا علاقة لها بالتسوق، قل فقط: "
    "'الصورة غير واضحة، وضّح طلبك بالنص.' ولا تكتب سطر SEARCH."
)
